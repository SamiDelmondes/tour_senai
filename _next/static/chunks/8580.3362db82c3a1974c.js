        ...
        g = (0, s.memo)(function (n) {
          var o = n.krpanoRef,
            ...
            j = (0, s.useCallback)(
              function () {
                return T(function (n) {
                  return (0, e.Z)((0, r.Z)({}, n), {
                    isShowControlbar: !n.isShowControlbar,
                  });
                });
              },
              [T],
          ...
          return (0, c.jsxs)("div", {
            ...
            children: [
              P &&
                ...
                (0, c.jsx)(u.Z, {
                  title: v.on
                    ? d.a[m].controlbarTurnOffSoundProject
                    : d.a[m].controlbarTurnOnSoundProject,
                  placement: "top",
                  children: (0, c.jsx)("button", {
                    ...
                    onClick: v.on ? O : A,
                    children: S(
                      v.on ? "sound_project_off" : "sound_project_on",
                    ),
                  }),
                }),
              R &&
                ...
                (0, c.jsx)(u.Z, {
                  trigger: "hover",
                  title: d.a[m].controlbarFloorplan,
                  placement: "top",
                  children: (0, c.jsx)("button", {
                    type: "button",
                    className: "act",
                    onClick: _.bind(h, void 0),
                    children: S("floorplan"),
                  }),
                }),
              k &&
                g("map") &&
                (0, c.jsx)(u.Z, {
                  trigger: "hover",
                  title: d.a[m].controlbarMap,
                  placement: "top",
                  children: (0, c.jsx)("button", {
                    type: "button",
                    className: "act",
                    onClick: N.bind(h, void 0),
                    children: S("map"),
                  }),
                }),
              g("fullscreen") &&
                (0, c.jsx)(u.Z, {
                  trigger: "hover",
                  title: d.a[m].controlbarFullscreen,
                  placement: "top",
                  children: (0, c.jsx)("button", {
                    type: "button",
                    className: "act ",
                    onClick: w,
                    children: S("fullscreen"),
                  }),
                }),
              g("gyro") &&
                (0, c.jsx)("button", {
              ...
              (0, c.jsx)("button", {
                ...
                onClick: j,
                children: (0, c.jsx)("i", {
                  className: "fal fa-angle-down ".concat(
                    y.isShowControlbar ? "" : "hide",
                  ),
                }),
              }),
            ],
